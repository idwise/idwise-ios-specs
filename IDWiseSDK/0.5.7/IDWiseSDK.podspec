...
Pod::Spec.new do |s|
  ...
  s.source           = { :git => 'https://github.com/idwise/idwise-ios-sdk.git', :tag => '0.5.7' }
  ...
  s.dependency 'AcuantiOSSDKV11/AcuantImagePreparation', '~> 11.4.7'
  s.dependency 'AcuantiOSSDKV11/AcuantHGLiveness', '~> 11.4.7'
  s.dependency 'AcuantiOSSDKV11/AcuantDocumentProcessing', '~> 11.4.7'
