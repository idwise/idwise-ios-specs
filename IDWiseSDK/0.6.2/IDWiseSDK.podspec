...
Pod::Spec.new do |s|
  ...
  s.dependency 'AcuantiOSSDKV11/AcuantImagePreparation', '~> 11.4.1'
  s.dependency 'AcuantiOSSDKV11/AcuantHGLiveness', '~> 11.4.1'
  s.dependency 'AcuantiOSSDKV11/AcuantDocumentProcessing', '~> 11.4.1'
